...
public class BaseConsumerImpl<K extends Serializable, V extends Serializable> extends BaseConsumerV2{
    public static final Logger logger = LoggerFactory.getLogger(BaseConsumerImpl.class.getName());


    public BaseConsumerImpl(Properties consumerProps, List<String> topics) {
       super(consumerProps, topics);
    }
    ...
    @Override
    public void processRecords(ConsumerRecords records) {
        records.forEach(record -> processRecord((ConsumerRecord)record));
    }
    ...
    public static void main(String[] args) {
        ...
        BaseConsumerImpl<String, String> baseConsumer = new BaseConsumerImpl<String, String>(props, List.of(topicName));
