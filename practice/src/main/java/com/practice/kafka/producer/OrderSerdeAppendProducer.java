...
import com.practice.kafka.event.OrderSerdeEventHandler;
...
public class OrderSerdeAppendProducer {
    public static final Logger logger = LoggerFactory.getLogger(OrderSerdeAppendProducer.class.getName());
    ...
    public static void main(String[] args) {
        ...
        EventHandler eventHandler = new OrderSerdeEventHandler(kafkaProducer, topicName, sync);
